 ...
 * 
 * Copyright 2017 desk <desk@desk-VirtualBox>
 * 
...
// 1D morse oscillator, and input via cvib.inp
...
double xstart=-12.0,xend=12.0,deltax=0.2;     	// basis parameters 
double d=12.0,w=0.5;						// potential parameters for harmonic and morse 1D tasks 
int nbas=128,npow=16,nmodes=1;
...
if (friend==1)
{
 ...
 gamess_1d(task_type,nmodes,nmodes*(nmodes-1)/2,nbas);	
